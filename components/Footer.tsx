        ...
        <footer className="text-center lg:text-left bg-gray-100 text-gray-600">
          ...
          <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
            ...
            <div className="flex justify-center">
              ...
              <a href="#!" className="mr-6 border-purple-600">
                <svg
                  aria-hidden="true"
                  focusable="false"
                  data-prefix="fab"
          ...
          "
                >
                  <User size={16} /> &nbsp; HG Prashant Mukund Das
                </h6>
                <p>
                  In his proffessional life, he has worked with big multi
                  national companies like Novartis, WNS, Millward Brown. Now, he
              ...
              <div className="">
                ...
                <p className="mb-4">
                  <a
                    href="https://names.iskcondesiretree.com/"
                    className="text-gray-600"
                  >
                    Vedic names
                  </a>
